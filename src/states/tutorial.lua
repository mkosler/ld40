...
function Tutorial:init()
    ...
    -- table.insert(self.labels, Label())
    -- self.labels[#self.labels]:setf("We tape the customer's desired seasoning levels to the bowl. Each seasoning has a small range that they customer will accept, marked with brackets on the order.", 600)
